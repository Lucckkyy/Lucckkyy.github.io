<html>
<head>
	<title>Checker PayPal By:LLoTus</title>
...
<div class="card col-sm-8">
  <h5 class="card-body h6">💰 Checker BB CIelo 💰</h5>
  <div class="card-body">
    <center><span><span class='badge badge-dark'>©𝕃𝕃𝕆𝕋𝕌𝕊</span></td></tr></span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
  <label for="lista">Email:Senha</label>
</div>
</div>
<center>
...
<div class="card col-sm-2">
  ...
  <div class="card-body">
    <span>Checker:</span>
    <span class="badge badge-secondary">Checker BB Cielo.</span>
    <span>Discord:</span>
    <span class="badge badge-secondary">L L O T U S ⱽᵃᵖᵒ 💸#0157.</span>
  	<span>Status:</span>
    <span class="badge badge-secondary">Aguardando o comando.</span>
    <span>Proxy:</span>
    <span class="badge badge-secondary">Funcionando apify.</span>
<div class="md-form">
...
<div class="card">
	<div style="position: absolute;
        top: 0;
        right: 0;">
	<button id="mostra2" class="btn btn-primary">Mostrar/Esconder</button>
</div>
  <div class="card-body">
                ...
                function() {
                    $.ajax({
                        ...
                        success: function(resultado) {
                            if (resultado.match("ʟɪᴠᴇ ɢᴇʀᴀᴅᴀ")) {
                                removelinha();
                                ap++;
                                aprovadas(resultado + "");
                            }else {
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">Copyright by LLoTus
    </div>
